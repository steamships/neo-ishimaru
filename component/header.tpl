				...
				<li class="nav-item">
					...
					<!-- ギフト券 -->
						<ul class="g-sub-nav gift-group sub-nav d-flex flex-wrap list-unstyled justify-content-lg-center justify-content-start  TrajanSB w-100 py-1 pt-lg-3 pb-lg-10 my-1">
							...
							<li class="g-sub-nav-blists mx-lg-2 text-center">
								<a class="g-sub-nav-blists-link mb-1 text-decoration-none d-inline-block" href="https://www.saga-ishimaru.co.jp/?pid=169231798"><span class="d-block text-center NotoSerifL">特選佐賀牛カタログギフトセット　10,000円コース</span></a>
							</li>
							<li class="g-sub-nav-blists mx-lg-2 text-center">
								<a class="g-sub-nav-blists-link mb-1 text-decoration-none d-inline-block" href="https://www.saga-ishimaru.co.jp/?pid=169231809"><span class="d-block text-center NotoSerifL">特選佐賀牛カタログギフトセット　14,000円コース</span></a>
							</li>
						</ul>
					<!-- // ギフト券 -->
				</li>
				<li class="nav-item">
					...
					<!-- ふるさと納税リスト -->
						<ul class="g-sub-nav price-group sub-nav d-flex flex-wrap list-unstyled justify-content-lg-center justify-content-evenly TrajanSB w-100 py-1 pt-lg-3 pb-lg-10 my-1">
							<li class="g-sub-nav-blists mx-lg-2 text-center">
								<a class="g-sub-nav-blists-link mb-1 text-decoration-none d-inline-block" href="https://search.rakuten.co.jp/search/mall/%E7%9F%B3%E4%B8%B8%E9%A3%9F%E8%82%89/" target="_blank" rel="noopener"><img class="g-sub-nav-blists-img mb-1" src="<{$assets}>/img/neo-furusato-rakuten.webp"><span class="d-block text-left text-lg-center NotoSerifL">楽天ふるさと納税</span></a>
							</li>
							<li class="g-sub-nav-blists mx-lg-2 text-center">
								<a class="g-sub-nav-blists-link mb-1 text-decoration-none d-inline-block" href="https://www.furusato-tax.jp/search?header=1&target=1&q=%E7%9F%B3%E4%B8%B8%E9%A3%9F%E8%82%89%E7%94%A3%E6%A5%AD" target="_blank" rel="noopener"><img class="g-sub-nav-blists-img mb-1" src="<{$assets}>/img/neo-furusato-choice.webp"><span class="d-block text-left text-lg-center NotoSerifL">ふるさとチョイス</span></a>
							</li>
							<li class="g-sub-nav-blists mx-lg-2 text-center">
								<a class="g-sub-nav-blists-link mb-1 text-decoration-none d-inline-block" href="https://furunavi.jp/Product/Search?keyword=%E7%9F%B3%E4%B8%B8%E9%A3%9F%E8%82%89" target="_blank" rel="noopener"><img class="g-sub-nav-blists-img mb-1" src="<{$assets}>/img/neo-furusato-furunavi.webp"><span class="d-block text-left text-lg-center NotoSerifL">ふるなび</span></a>
							</li>
							<li class="g-sub-nav-blists mx-lg-2 text-center">
								<a class="g-sub-nav-blists-link mb-1 text-decoration-none d-inline-block" href="https://www.satofull.jp/products/list.php?q=%E7%9F%B3%E4%B8%B8%E9%A3%9F%E8%82%89&cnt=120&p=1" target="_blank" rel="noopener"><img class="g-sub-nav-blists-img mb-1" src="<{$assets}>/img/neo-furusato-satofuru.webp"><span class="d-block text-left text-lg-center NotoSerifL">さとふる</span></a>
							</li>
						</ul>
					<!-- // ふるさと納税リスト -->
				</li>
...
<div class="container">
	...
	<{if $tpl_name != "top"}>
	<!-- カテゴリのパンくずリスト -->
	<ol class="breadcrumb list-unstyled NotoSerifL ps-1">
		<li class="d-inline-block"><a class="text-decoration-none" href="<{$home_url}>">TOP</a></li>
	...
	<{if $group_breadcrumb_list != ""}>
		<ol class="breadcrumb sub list-unstyled NotoSerifL ps-1">
