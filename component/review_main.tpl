...
<article id="review">
	...
	<img class="d-lg-none d-block my-1 mx-auto"
	...
	<div class="row row-cols-2">
		...
		<a class="w-75 d-inline-flex mx-auto align-items-center justify-content-center btn btn-outline-secondary NotoSerifL fs-18px mt-1 py-1 ls-1 chevron-right"
