		...
		<div class="carousel-inner">
			<div class="carousel-item active" data-bs-interval="6000">
				<a href="https://www.saga-ishimaru.co.jp/?mode=grp&gid=2483504">
					<img src="<{$assets}>/img/neo-slide-oseibo2022-pc.webp" class="d-none d-lg-block w-100" alt="カタログギフト">
					<img src="<{$assets}>/img/neo-slide-oseibo2022-sp.webp" class="d-lg-none d-block w-100" alt="カタログギフト">
				</a>
			</div>
